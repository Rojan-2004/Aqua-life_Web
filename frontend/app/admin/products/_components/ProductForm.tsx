    ...
    return (
        <form onSubmit={onSubmit} className="font-sans">
            <div className="mb-10">
                ...
                <h2 className="text-4xl font-bold text-white mt-2 mb-2">Create Product</h2>
                <p className="text-base text-slate-400">Add a new aquatic item to the live store listing.</p>
            </div>
            ...
            <div className="space-y-10">
                ...
                {/* Product Images */}
                <section className="border border-slate-800 bg-slate-900/40 rounded-xl p-8">
                    <h3 className="text-base font-bold text-cyan-400 uppercase tracking-[1px] mb-8">Product Images</h3>
                ...
                <section className="border border-slate-800 bg-slate-900/40 rounded-xl p-8">
                    ...
                    <div className="space-y-7">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <label htmlFor="featured" className="text-base text-slate-300">
