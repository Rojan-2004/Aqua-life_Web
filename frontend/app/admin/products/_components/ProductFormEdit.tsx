        ...
        <form onSubmit={onSubmit} className="font-sans">
            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-800/60 pb-6">
                <div>
                    ...
                    <h2 className="text-3xl font-extrabold text-white mt-3">Edit Product</h2>
                    <p className="text-sm text-slate-400 mt-1">Modify live product information, details, or catalog assets.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                {/* Left Form controls (2 Columns Span) */}
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className={cardClass}>
                        ...
                        <div>
                            <textarea
                                ...
                                placeholder="Describe the item specifications, dimensions, features, and setup instructions..."
                                rows={5}
                    ...
                    <div className={cardClass}>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center gap-3 bg-slate-955/20 border border-slate-800/40 p-4 rounded-xl">
                                <input
                                    id="featured-edit"
                                    type="checkbox"
                                    checked={isFeatured}
                                ...
                                />
                                <label htmlFor="featured-edit" className="text-sm font-semibold text-slate-300 cursor-pointer">
